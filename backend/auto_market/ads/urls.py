...
urlpatterns = [
    ...
    path('cars/delete/<int:car_ad_id>/', DeleteCarAdView.as_view(), name='delete-car-ad'),
    path('cars/update/<int:car_ad_id>/', UpdateCarAdView.as_view(), name='update-car-ad'),
    path('cars/<int:car_ad_id>/', DetailCarAdView.as_view(), name='detail-car-ad'),
    path('cars/restore-ad/<int:car_ad_id>/', RestoreCarAdView.as_view(), name='restore-ad'),

    # Image Views:
    path('cars/<int:car_ad_id>/images/create/', CarImageUploadView.as_view(), name='upload-car-image'),
    path('cars/<int:car_ad_id>/images/<int:image_id>/', CarImageDeleteView.as_view(), name='delete-car-image'),
    path('cars/<int:car_ad_id>/images/list/', CarImageListView.as_view(), name='list-car-image'),
