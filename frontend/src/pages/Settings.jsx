          ...
          <div className="bg-surface rounded-2xl border border-border p-6 shadow-sm">
            ...
            {step === 1 ? (
              ...
              <form onSubmit={handlePhoneVerifyAndChange} className="space-y-4">
                <div className="bg-brand-50 dark:bg-brand-950 border border-brand-100 dark:border-brand-800 p-4 rounded-xl text-sm text-brand-800 dark:text-brand-200 leading-relaxed">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="۱۲۳۴۵۶"
                      className="w-full pr-10 pl-4 py-3 bg-surface-tertiary border border-border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/20 text-center tracking-widest font-bold"
                      required
                    />
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={phoneLoading}
                    className="w-2/3 flex items-center justify-center gap-2 px-4 py-3 bg-brand-500 hover:bg-brand-600 text-white font-semibold rounded-xl transition-colors disabled:opacity-50"
                  >
